...
import { Fisheye, MotionPathControls, useMotion, useTexture, Cloud, OrbitControls, MeshWobbleMaterial, Gltf, Float, Environment } from '@react-three/drei'
...
export function App() {
  ...
  return (
    <Canvas camera={{ position: [10, 15, -10], fov: 45 }}>
      ...
      <Cloud opacity={0.5} position={[0, 0, -10]} speed={0.02} />
      <Cloud opacity={0.5} position={[10, 0, 0]} speed={0.02} />
